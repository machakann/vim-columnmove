...
let s:suite_w = themis#suite('columnmove-w:')
function! s:suite_w.before_each() abort  "{{{
  mapclear
  mapclear!
...
"}}}
function! s:suite_w.after() abort  "{{{
  call s:suite_w.before_each()
  mapclear
  mapclear!
endfunction
"}}}

function! s:suite_w.strict() abort  "{{{
  ...
  call append(0, ['a', 'b', ' ', 'c', 'd'])
  normal 3G0\w
  call g:assert.equals(line('.'), 4, 'failed at #8')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['a', 'b', '', 'c', 'd'])
  normal 1G0\w
  call g:assert.equals(line('.'), 4, 'failed at #11')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['a', 'b', '', 'c', 'd'])
  normal 2G0\w
  call g:assert.equals(line('.'), 4, 'failed at #12')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['a', 'b', '', 'c', 'd'])
  normal 3G0\w
  call g:assert.equals(line('.'), 4, 'failed at #13')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['a', 'b', '', 'c', 'd'])
  normal 4G0\w
  call g:assert.equals(line('.'), 4, 'failed at #14')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [';', ':', 'a', ',', '.'])
  normal 1G0\w
  call g:assert.equals(line('.'), 3, 'failed at #16')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [';', ':', 'a', ',', '.'])
  normal 3G0\w
  call g:assert.equals(line('.'), 4, 'failed at #18')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [';', ':', ' ', ',', '.'])
  normal 1G0\w
  call g:assert.equals(line('.'), 4, 'failed at #21')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [';', ':', ' ', ',', '.'])
  normal 2G0\w
  call g:assert.equals(line('.'), 4, 'failed at #22')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [';', ':', ' ', ',', '.'])
  normal 3G0\w
  call g:assert.equals(line('.'), 4, 'failed at #23')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [';', ':', '', ',', '.'])
  normal 1G0\w
  call g:assert.equals(line('.'), 4, 'failed at #26')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [';', ':', '', ',', '.'])
  normal 2G0\w
  call g:assert.equals(line('.'), 4, 'failed at #27')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [';', ':', '', ',', '.'])
  normal 3G0\w
  call g:assert.equals(line('.'), 4, 'failed at #28')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [';', ':', '', ',', '.'])
  normal 4G0\w
  call g:assert.equals(line('.'), 4, 'failed at #29')
  call columnmove#interrupt()
  %delete
  ...
  normal \w
  call g:assert.equals(line('.'), 7, 'failed at #61')
  call columnmove#interrupt()
  %delete
endfunction
"}}}
function! s:suite_w.strict_count() abort "{{{
  let g:columnmove_strict_wbege = 1
  ...
  call append(0, ['a', 'b', ' ', 'c', 'd', ':', 'e'])
  normal 1G02\w
  call g:assert.equals(line('.'), 6, 'failed at #2')
  call columnmove#interrupt()
  %delete
...
"}}}
function! s:suite_w.strict_fold() abort  "{{{
  let g:columnmove_strict_wbege = 1
  ...
  3,4fold
  normal 1G0\w
  call g:assert.equals(line('.'), 6, 'failed at #3')
  call columnmove#interrupt()
  %delete
  ...
  6,7fold
  normal 1G0\w
  call g:assert.equals(line('.'), 8, 'failed at #7')
  call columnmove#interrupt()
  %delete
endfunction
"}}}
function! s:suite_w.strict_option_fold_treatment() abort  "{{{
  let g:columnmove_strict_wbege = 1
  ...
  5,6fold
  normal 1G0\w
  call g:assert.equals(line('.'), 7, 'failed at #5')
  call columnmove#interrupt()
  %delete
...
"}}}
function! s:suite_w.strict_option_fold_open() abort  "{{{
  let g:columnmove_strict_wbege = 1
...
"}}}
function! s:suite_w.strict_option_combinations() abort "{{{
  let g:columnmove_strict_wbege = 1
  let g:columnmove_fold_treatment = 1
  let g:columnmove_fold_open = 1
...
"}}}
function! s:suite_w.strict_option_stop_on_space() dict abort  "{{{
  let g:columnmove_stop_on_space = 1

  " #1
  call append(0, ['aa', 'bb', '', '  ', 'dd'])
  normal 1G0\w
...
"}}}
function! s:suite_w.strict_curswant() abort "{{{
  let g:columnmove_strict_wbege = 1
  ...
  normal 1G0$j\w
  call g:assert.equals(getpos('.')[1:2], [4, 3], 'failed at #1')
  call columnmove#interrupt()
  %delete
endfunction
"}}}
function! s:suite_w.strict_tabchar() abort "{{{
  let g:columnmove_strict_wbege = 1
  ...
  normal 1G0fa\w
  call g:assert.equals(getpos('.')[1:2], [4, 5], 'failed at #1')
  call columnmove#interrupt()
  %delete
...
"}}}
function! s:suite_w.strict_multibyte_char() abort "{{{
  let g:columnmove_strict_wbege = 1
  ...
  call append(0, ['αbc', 'defg', '', 'hijk'])
  normal 1G02l\w
  call g:assert.equals(getpos('.')[1:2], [4, 3], 'failed at #3')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['abc', 'δefg', '', 'hijk'])
  normal 1G0l\w
  call g:assert.equals(getpos('.')[1:2], [4, 2], 'failed at #5')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['abc', 'δefg', '', 'hijk'])
  normal 1G02l\w
  call g:assert.equals(getpos('.')[1:2], [4, 3], 'failed at #6')
  call columnmove#interrupt()
  %delete
  ...
  normal 1G0\w
  call g:assert.equals(getpos('.')[1:2], [4, 1], 'failed at #7')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['abc', 'defg', '', 'ηijk'])
  normal 1G0l\w
  call g:assert.equals(getpos('.')[1:2], [4, strlen('η')+1], 'failed at #8')
  let @@ = ''
  normal! yl
  ...
  call append(0, ['abc', 'defg', '', 'ηijk'])
  normal 1G02l\w
  call g:assert.equals(getpos('.')[1:2], [4, strlen('η')+2], 'failed at #9')
  let @@ = ''
  normal! yl
  ...
  call append(0, ['αbc', 'defg', '', 'hijk'])
  normal 1G0l\w
  call g:assert.equals(getpos('.')[1:2], [4, 3], 'failed at #11')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['αbc', 'defg', '', 'hijk'])
  normal 1G02l\w
  call g:assert.equals(getpos('.')[1:2], [4, 4], 'failed at #12')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['abc', 'δefg', '', 'hijk'])
  normal 1G0\w
  call g:assert.equals(getpos('.')[1:2], [4, 1], 'failed at #13')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['abc', 'δefg', '', 'hijk'])
  normal 1G0l\w
  call g:assert.equals(getpos('.')[1:2], [4, 2], 'failed at #14')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['abc', 'δefg', '', 'hijk'])
  normal 1G02l\w
  call g:assert.equals(getpos('.')[1:2], [4, 3], 'failed at #15')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['abc', 'defg', '', 'ηijk'])
  normal 1G0\w
  call g:assert.equals(getpos('.')[1:2], [4, 1], 'failed at #16')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, ['abc', 'defg', '', 'ηijk'])
  normal 1G0l\w
  call g:assert.equals(getpos('.')[1:2], [4, 1], 'failed at #17')
  let @@ = ''
  normal! yl
  ...
  call append(0, ['abc', 'defg', '', 'ηijk'])
  normal 1G02l\w
  call g:assert.equals(getpos('.')[1:2], [4, strlen('η')+1], 'failed at #18')
  let @@ = ''
  normal! yl
...
"}}}
function! s:suite_w.strict_visual_mode() abort  "{{{
  let g:columnmove_strict_wbege = 1
...
"}}}
function! s:suite_w.strict_operator_pending_mode() abort  "{{{
  let g:columnmove_strict_wbege = 1
...
"}}}
function! s:suite_w.spoiled() abort "{{{
  ...
  call append(0, [' ', ' ', '', ' ', ' '])
  normal 1G0\w
  call g:assert.equals(line('.'), 4, 'failed at #41')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [' ', ' ', '', ' ', ' '])
  normal 2G0\w
  call g:assert.equals(line('.'), 4, 'failed at #42')
  call columnmove#interrupt()
  %delete
  ...
  call append(0, [' ', ' ', '', ' ', ' '])
  normal 3G0\w
  call g:assert.equals(line('.'), 4, 'failed at #43')
  call columnmove#interrupt()
  %delete
...
"}}}
function! s:suite_w.spoiled_count() abort "{{{
  let g:columnmove_strict_wbege = 0
...
"}}}
function! s:suite_w.spoiled_fold() abort  "{{{
  let g:columnmove_strict_wbege = 0
...
"}}}
function! s:suite_w.spoiled_option_fold_treatment() abort  "{{{
  let g:columnmove_strict_wbege = 0
  let g:columnmove_fold_treatment = 1
...
"}}}
function! s:suite_w.spoiled_option_fold_open() abort  "{{{
  let g:columnmove_strict_wbege = 0
  let g:columnmove_fold_open = 1
...
"}}}
function! s:suite_w.spoiled_option_combinations() abort "{{{
  let g:columnmove_strict_wbege = 0
  let g:columnmove_fold_treatment = 1
  let g:columnmove_fold_open = 1
...
"}}}
function! s:suite_w.spoiled_option_stop_on_space() dict abort  "{{{
  let g:columnmove_strict_wbege = 0
  let g:columnmove_stop_on_space = 1
...
"}}}
function! s:suite_w.spoiled_curswant() abort "{{{
  let g:columnmove_strict_wbege = 0
...
"}}}
function! s:suite_w.spoiled_tabchar() abort "{{{
  let g:columnmove_strict_wbege = 0
...
"}}}
function! s:suite_w.spoiled_multibyte_char() abort "{{{
  let g:columnmove_strict_wbege = 0
...
"}}}
function! s:suite_w.spoiled_visual_mode() abort  "{{{
  let g:columnmove_strict_wbege = 0
...
"}}}
function! s:suite_w.spoiled_operator_pending_mode() abort  "{{{
  let g:columnmove_strict_wbege = 0
